...
let INCLUSION_EXCLUSION_SYMMETRIC = prove
 (`!f g:(A->bool)->real.
  ...
  REPEAT STRIP_TAC THEN (CONV_TAC "SYM_CONV") SYM_CONV THEN MATCH_MP_TAC EQ_TRANS THEN
...
let INCLUSION_EXCLUSION_MOBIUS = prove
 (`!f g:(A->bool)->real.
  ...
  REWRITE_TAC[GSYM REAL_POW_POW] THEN (CONV_TAC "REAL_RAT_REDUCE_CONV") REAL_RAT_REDUCE_CONV THEN
