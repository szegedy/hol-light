...
let PURE_REWRITE_TAC thl = (CONV_TAC "(PURE_REWRITE_CONV thl)") (PURE_REWRITE_CONV thl);;

let REWRITE_TAC thl = (CONV_TAC "(REWRITE_CONV thl)") (REWRITE_CONV thl);;

let PURE_ONCE_REWRITE_TAC thl = (CONV_TAC "(PURE_ONCE_REWRITE_CONV thl)") (PURE_ONCE_REWRITE_CONV thl);;

let ONCE_REWRITE_TAC thl = (CONV_TAC "(ONCE_REWRITE_CONV thl)") (ONCE_REWRITE_CONV thl);;
