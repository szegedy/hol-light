 ...
 (`!s t:real^N->bool.
  ...
  REPEAT CONJ_TAC THENL
   [REPEAT GEN_TAC THEN MATCH_MP_TAC MONO_IMP THEN
    ...
    (CONV_TAC "(LAND_CONV(BINOP_CONV HAS_SIZE_CONV))") (LAND_CONV(BINOP_CONV HAS_SIZE_CONV)) THEN
     ...
     [REMOVE_THEN "+" (K ALL_TAC) THEN REMOVE_THEN "*" MP_TAC THEN
      ...
      MP_TAC THENL
       [FIRST_ASSUM(MATCH_MP_TAC o MATCH_MP CHOOSE_SUBSET o
        ...
        ALL_TAC] THEN
      (CONV_TAC "(LAND_CONV(ONCE_DEPTH_CONV HAS_SIZE_CONV))") (LAND_CONV(ONCE_DEPTH_CONV HAS_SIZE_CONV)) THEN
  ...
  ASM_REWRITE_TAC[] THEN ANTS_TAC THENL
   [REPEAT CONJ_TAC THENL
     [EXPAND_TAC "n" THEN MATCH_MP_TAC LTE_ADD2 THEN
      ...
      (CONV_TAC "(RAND_CONV SYM_CONV)") (RAND_CONV SYM_CONV) THEN ASM_SIMP_TAC[REAL_LT_IMP_NZ];
   ...
   [MATCH_MP_TAC REALLIM_TRANSFORM_EVENTUALLY THEN
    ...
    REWRITE_TAC[] THEN CONJ_TAC THENL
     [REWRITE_TAC[EVENTUALLY_WITHINREAL] THEN
      ...
      REPEAT STRIP_TAC THEN BINOP_TAC THEN (CONV_TAC "SYM_CONV") SYM_CONV THEN
 ...
 (`!s t:real^N->bool.
  ...
  REWRITE_TAC[] THEN REPEAT CONJ_TAC THENL
   [ASM ((CONV_TAC "o") o GEN_SIMPLIFY_CONV TOP_DEPTH_SQCONV (basic_ss []) 5)
    ...
    ASM ((CONV_TAC "o") o GEN_SIMPLIFY_CONV TOP_DEPTH_SQCONV (basic_ss []) 6)
     [REAL_ROOT_RPOW; DIMINDEX_NONZERO; MEASURE_POS_LE; MEASURABLE_COMPACT;
