  ...
  let NUM_SQUARE_RULE =
    ...
    and pth_rec = (UNDISCH o STANDARDIZE o prove)
     (`n = l + p * h /\
      ...
      REWRITE_TAC[MULT_AC] THEN CONV_TAC "(BINOP_CONV NUM_CANCEL_CONV)" (BINOP_CONV NUM_CANCEL_CONV) THEN
    ...
    and pth_toom3 = (STANDARDIZE o prove)
     (`h EXP 2 = e /\
      ...
      CONV_TAC "(LAND_CONV NUM_CANCEL_CONV)" (LAND_CONV NUM_CANCEL_CONV) THEN DISCH_THEN SUBST_ALL_TAC THEN
      FIRST_ASSUM(MP_TAC o MATCH_MP (MESON[]
       `b = b' /\ c = c' /\ d = d'
      ...
      REWRITE_TAC(map (fun k ->
         ...
         (1--4)) THEN
      REWRITE_TAC[MULT_CLAUSES; ADD_CLAUSES] THEN
      CONV_TAC "(LAND_CONV(BINOP_CONV NUM_CANCEL_CONV))" (LAND_CONV(BINOP_CONV NUM_CANCEL_CONV)) THEN
...
let NUM_REDUCE_TAC = CONV_TAC "NUM_REDUCE_CONV" NUM_REDUCE_CONV;;
